"""
Django settings for noisy_glitter_dev_97749 project.
...
ROOT_URLCONF = 'noisy_glitter_dev_97749.urls'
...
WSGI_APPLICATION = 'noisy_glitter_dev_97749.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_glitter_dev_97749 API",
    "DESCRIPTION": "API documentation for noisy_glitter_dev_97749 App",
    "VERSION": "v1",
}
